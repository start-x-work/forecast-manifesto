...
公知の数式・モデル構造（NBD 等）のみを実装した需要予測ソルバー。書籍本文の転載はしない。
...
It implements publicly known demand-forecasting formulas and model structures (NBD and related models); no book text is reproduced.
