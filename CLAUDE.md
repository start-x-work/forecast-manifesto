...
命名規則: `feature/<番号-または-連番>-<内容>`。番号がなければ日付や連番（例: `feature/2026-08-18-fix-mail-status`）でも可。
...
# 2. 各 PR のブランチを取得して順に cherry-pick
...
# 5. 統合元の個別 PR は「この PR に統合してクローズした」旨をコメントし、close する
